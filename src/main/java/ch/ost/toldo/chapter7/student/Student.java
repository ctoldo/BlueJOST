...
public class Student {
  ...
  public static Integer ANZAHL_OBJEKTE = 0;
  ...
  /**
   * gibt Anzahl erstellter Studenten Objekte zurück
   * @return Anzahl erstellter Studenten-Objekte
   */
  public Integer gibAnzahlObjekte() {
